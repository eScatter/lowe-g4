...
//EB: Prevent warning for low energy particles, the deposited energy
//    may become negative during some steps although the total will
//    always be positive
//    2.0e-5 corresponds to a 20eV trip level for warnings which should
//    normally be enough
//Original: const G4double G4VParticleChange::accuracyForWarning = 1.0e-9;
const G4double G4VParticleChange::accuracyForWarning = 2.0e-5;
