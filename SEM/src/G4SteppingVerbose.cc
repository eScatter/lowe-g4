...
// Show G4StepPoint specific information
   ...
   G4cout << "      -------------------------------------------------------" 
        << "----------------" <<  G4endl;
   G4cout << "         Position - x (mm)   : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetPosition().x() 
        << std::setw(25) << fStep->GetPostStepPoint()->GetPosition().x() << G4endl;
   G4cout << "         Position - y (mm)   : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetPosition().y() 
        << std::setw(25) << fStep->GetPostStepPoint()->GetPosition().y() << G4endl;
   G4cout << "         Position - z (mm)   : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetPosition().z() 
        << std::setw(25) << fStep->GetPostStepPoint()->GetPosition().z() << G4endl;
   G4cout << "         Global Time (ns)    : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetGlobalTime()
        << std::setw(25) << fStep->GetPostStepPoint()->GetGlobalTime() << G4endl;
   G4cout << "         Local Time (ns)     : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetLocalTime() 
        << std::setw(25) << fStep->GetPostStepPoint()->GetLocalTime() << G4endl;
   G4cout << "         Proper Time (ns)    : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetProperTime()
        << std::setw(25) << fStep->GetPostStepPoint()->GetProperTime() << G4endl;
   G4cout << "         Momentum Direct - x : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetMomentumDirection().x()
        << std::setw(25) << fStep->GetPostStepPoint()->GetMomentumDirection().x() << G4endl;
   G4cout << "         Momentum Direct - y : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetMomentumDirection().y()
        << std::setw(25) << fStep->GetPostStepPoint()->GetMomentumDirection().y() << G4endl;
   G4cout << "         Momentum Direct - z : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetMomentumDirection().z()
        << std::setw(25) << fStep->GetPostStepPoint()->GetMomentumDirection().z() << G4endl;
   G4cout << "         Momentum - x (MeV/c): " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetMomentum().x()
        << std::setw(25) << fStep->GetPostStepPoint()->GetMomentum().x() << G4endl;
   G4cout << "         Momentum - y (MeV/c): " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetMomentum().y()
        << std::setw(25) << fStep->GetPostStepPoint()->GetMomentum().y() << G4endl;
   G4cout << "         Momentum - z (MeV/c): " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetMomentum().z()
        << std::setw(25) << fStep->GetPostStepPoint()->GetMomentum().z() << G4endl;
   G4cout << "         Total Energy (MeV)  : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetTotalEnergy()
        << std::setw(25) << fStep->GetPostStepPoint()->GetTotalEnergy() << G4endl;
   G4cout << "         Kinetic Energy (MeV): " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetKineticEnergy()
        << std::setw(25) << fStep->GetPostStepPoint()->GetKineticEnergy() << G4endl;
   G4cout << "         Velocity (mm/ns)    : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetVelocity()
        << std::setw(25) << fStep->GetPostStepPoint()->GetVelocity() << G4endl;
   G4cout << "         Volume Name         : "
        << std::setw(25) << fStep->GetPreStepPoint()->GetPhysicalVolume()->GetName();
   ...
   G4cout << std::setw(25) << volName << G4endl;
   G4cout << "         Safety (mm)         : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetSafety()
        << std::setw(25) << fStep->GetPostStepPoint()->GetSafety() << G4endl;
   G4cout << "         Polarization - x    : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetPolarization().x()
        << std::setw(25) << fStep->GetPostStepPoint()->GetPolarization().x() << G4endl;
   G4cout << "         Polarization - y    : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetPolarization().y()
        << std::setw(25) << fStep->GetPostStepPoint()->GetPolarization().y() << G4endl;
   G4cout << "         Polarization - Z    : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetPolarization().z()
        << std::setw(25) << fStep->GetPostStepPoint()->GetPolarization().z() << G4endl;
   G4cout << "         Weight              : " 
        << std::setw(25) << fStep->GetPreStepPoint()->GetWeight()
        << std::setw(25) << fStep->GetPostStepPoint()->GetWeight() << G4endl;
   G4cout << "         Step Status         : " ;
        G4StepStatus  tStepStatus = fStep->GetPreStepPoint()->GetStepStatus();
        if( tStepStatus == fGeomBoundary ){
           G4cout << std::setw(25) << "Geom Limit";
        } else if ( tStepStatus == fAlongStepDoItProc ){
          G4cout << std::setw(25) << "AlongStep Proc.";
        } else if ( tStepStatus == fPostStepDoItProc ){
           G4cout << std::setw(25) << "PostStep Proc";
        } else if ( tStepStatus == fAtRestDoItProc ){
           G4cout << std::setw(25) << "AtRest Proc";
        } else if ( tStepStatus == fUndefined ){
           G4cout << std::setw(25) << "Undefined";
        }
 	   ...
 	   G4cout << std::setw(25) << "Undefined";
  	   ...
  	   G4cout << std::setw(25) << fStep->GetPreStepPoint()->GetProcessDefinedStep()->GetProcessName();
        }
        if( fStep->GetPostStepPoint()->GetProcessDefinedStep() == 0){
  	   G4cout << std::setw(25) << "Undefined";
        } else {
 	   G4cout << std::setw(25) << fStep->GetPostStepPoint()->GetProcessDefinedStep()->GetProcessName(); 
        }
