                                                ...
                                                G4FacetVertexType vertexType)
{
  ...
  if (isDefined)
  {
    ...
    // EB: Change the ordering such that the diagonal corresponds to direction E[1]
    //     in both triangles. This prevents either hitting or missing both triangles
    //     at the same time due to round-off errors
    //Original code:
    //facet2 = new G4TriangularFacet(P0,P[1],P[2],ABSOLUTE);
    //New code:
    //facet2 = new G4TriangularFacet(P[1],P[2],P0,ABSOLUTE);
    // AT: adapted the above changes for the new G4.10 file:
    fFacet2 = G4TriangularFacet (GetVertex(2),GetVertex(3),
                                 GetVertex(0),ABSOLUTE);

    G4TriangularFacet facet3 (GetVertex(0),GetVertex(1),GetVertex(3),ABSOLUTE);
    // AT: also made the adaptions for facet4:
    G4TriangularFacet facet4 (GetVertex(2),GetVertex(3),GetVertex(1),ABSOLUTE);
